...
class Config(object):
    ...
    OWNER_ID = int(getenv("OWNER_ID", "5846541835"))  # sᴛᴀʀᴛ @Exon_Robot ᴛʏᴘᴇ /id
    OWNER_USERNAME = getenv("OWNER_USERNAME", "its_cute_boy")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "X_TEAM_IMMORTALS_X")
